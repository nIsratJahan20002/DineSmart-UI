...
const page = () => {
  return (
    <div className="min-h-screen flex flex-col items-center bg-white px-4">
      ...
      {/* Form shifted lower */}
      <div className="mt-4 w-full max-w-md border-2 border-amber-600 rounded-xl p-8 shadow-lg text-center">
        <form className="space-y-5">
          <div className="text-left">
            ...
            <input
              ...
              className="w-full mt-1 px-4 py-2 border-2 border-amber-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#f3492a]"
              required
            />
          </div>
          <div className="text-left">
